...
const translations = {
  ru: {
    ...
    accessibility: {
      ...
      schemeDefault: "Стандартная",
      schemeBlackWhite: "Чёрный фон, белый текст",
      schemeBlackGreen: "Чёрный фон, зелёный текст",
      schemeWhiteBlack: "Белый фон, чёрный текст",
      schemeBeigeBrown: "Бежевый фон, коричневый текст",
      schemeBlueDarkblue: "Голубой фон, тёмно-синий текст",
      imagesLabel: "Отключить изображения",
      close: "ЗАКРЫТЬ",
      reset: "СБРОСИТЬ",
    },
  },
  en: {
    ...
    checkout: {
      ...
      pickupMoscow: "Moscow",
      pickupMinsk: "Minsk",
      selectPickup: "Select a pickup point",
    ...
    accessibility: {
      ...
      schemeBlackWhite: "Black bg, white text",
      schemeBlackGreen: "Black bg, green text",
      schemeWhiteBlack: "White bg, black text",
      schemeBeigeBrown: "Beige bg, brown text",
      schemeBlueDarkblue: "Blue bg, dark blue text",
      imagesLabel: "Disable images",
      close: "CLOSE",
      reset: "RESET",
    },
  },
